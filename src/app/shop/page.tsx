      ...
      <section className="w-full md:pt-8 pt-7 md:mb-5 mb-3">
        <div className="w-[96%] mx-auto px-0">
          <div className="relative w-full h-[322px] md:h-[65vh] rounded-[26px] overflow-hidden">
            ...
            />
            <div className="absolute inset-0 z-10 h-full flex flex-col justify-start items-start text-left text-primary">
                <div className="container mx-auto px-8 md:px-12 lg:px-24 h-full flex flex-col justify-center">
