    ...
    <footer className="w-full mb-4">
      <div className="w-[96%] mx-auto pt-12 pb-4 text-foreground/80 rounded-[26px] border border-border/40 bg-[#F6F6F3]/80 backdrop-blur-lg px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 text-sm">
          <div>
            <div className="font-semibold text-foreground mb-4 text-sm">Useful Link</div>
          ...
          <div>
            <div className="font-semibold text-foreground mb-4 text-sm">Support</div>
            <ul className="space-y-2">
          ...
          <div>
            <div className="font-semibold text-foreground mb-4 text-sm">Information</div>
            <ul className="space-y-2">
          ...
          <div className="md:col-span-2">
            <div className="font-semibold text-foreground mb-4 text-sm">Sign Up to Our Newsletter</div>
