...
export function Header() {
  ...
  return (
    <header className="sticky top-4 z-50 w-full">
      <div className="container flex h-16 items-center justify-between rounded-2xl border-b border-border/40 bg-rose-50/80 backdrop-blur-lg px-8">
        ...
        <div className="flex items-center gap-2">
           <div className="relative hidden md:block">
             ...
             <Input type="search" placeholder="Search..." className="w-full rounded-full bg-white pl-9" />
           </div>
